...
@onready var _coyote_timer:Timer = Timer.new()
...
#region glide
func _on_glide_event(wants_to_glide)->void:
...
func _on_charge_event(wants_to_charge)->void:
	_wants_to_charge = wants_to_charge

#endregion charge
	
#region fade
func _on_fade_event(wants_to_fade)->void:
