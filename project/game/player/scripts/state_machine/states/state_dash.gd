...
func enter(_msg :Dictionary= {}) -> void:
	...
	dash_velocity = (2*player.player_movement_config.dash_distance) / player.player_movement_config.dash_time_to_peak
	dash_gravity = (-2*player.player_movement_config.dash_distance) / (player.player_movement_config.dash_time_to_peak *player.player_movement_config.dash_time_to_peak)
